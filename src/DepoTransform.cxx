...
#include "WireCellGenStdpar/DepoTransform.h"
...
GenStdpar::DepoTransform::DepoTransform()
...
void GenStdpar::DepoTransform::configure(const WireCell::Configuration& cfg)
{
...
WireCell::Configuration GenStdpar::DepoTransform::default_configuration() const
{
    Configuration cfg;
...
bool GenStdpar::DepoTransform::operator()(const input_pointer& in, output_pointer& out)
{
    ...
    for (auto face : m_anode->faces()) {
        ...
        for (auto plane : face->planes()) {
            ...
            GenStdpar::BinnedDiffusion_transform bindiff(*pimpos, tbins, m_nsigma, m_rng);
            ...
            GenStdpar::ImpactTransform transform(pir, m_dft, bindiff);
