#include "WireCellGenStdpar/ImpactData.h"
...
GenStdpar::ImpactData::ImpactData(int impact)
    : m_impact(impact)
{
}
void GenStdpar::ImpactData::add(GaussianDiffusion::pointer diffusion)
{
    m_diffusions.push_back(diffusion);
}

Waveform::realseq_t& GenStdpar::ImpactData::waveform() const
{
    return m_waveform;
}

Waveform::compseq_t& GenStdpar::ImpactData::spectrum() const
{
    return m_spectrum;
}

Waveform::realseq_t& GenStdpar::ImpactData::weightform() const
{
    return m_weights;
}

Waveform::compseq_t& GenStdpar::ImpactData::weight_spectrum() const
{
    return m_weight_spectrum;
}

void GenStdpar::ImpactData::calculate(const IDFT::pointer& dft, int nticks) const
{
...
// std::pair<int,int> GenStdpar::ImpactData::strip() const
// {
//     int imin=-1, imax = -1;
...
std::pair<double, double> GenStdpar::ImpactData::span(double nsigma) const
{
    int ncount = -1;
