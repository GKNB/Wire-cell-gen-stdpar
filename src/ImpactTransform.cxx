...
#include "WireCellGenStdpar/StdparArray.h"
...
bool GenStdpar::ImpactTransform::transform_matrix()
{
...
//  m_bd.get_charge_matrix_stdpar(f_data, dim_p, dim_t, m_vec_impact, start_pitch, m_start_tick);
  m_bd.get_charge_matrix_stdpar_noscan(f_data, dim_p, dim_t, m_vec_impact, start_pitch, m_start_tick);
  ...
  StdparArray::dft_rc(data_c, f_data, dim_p, dim_t, 0);
  StdparArray::dft_cc(data_c, data_c, dim_p, dim_t, 1);
...
//  Convolution with Field Response
  ...
  // fine grained resp. matrix
    ...
    StdparArray::idft_cr(sp_ts, sp_fs, sp_size, nimpact, 1);
    ...
    {
      StdparArray::dft_rc(resp_redu, sp_ts, fillsize, nimpact, 1);
    ...
    StdparArray::dft_cc(resp_f_w_k, resp_f_w_k, dim_p, dim_t, 1);
    ...
    StdparArray::idft_cc(data_c, data_c, dim_p, dim_t, 1);
  ...
  StdparArray::idft_cr(acc_data_t_w, acc_data_f_w, acc_dim_p, acc_dim_t, 0);
...
//bool GenStdpar::ImpactTransform::transform_matrix_old()
//{
//    double timer_transform = omp_get_wtime();
//    // arrange the field response (210 in total, pitch_range/impact)
//    // number of wires nwires ...
...
////  Notice f_data is not initialized in Stdpar code FIXME
...
////    StdparArray::dft_rc(data_c, f_data, dim_p, dim_t, 1);
////    StdparArray::dft_cc(data_c, data_c, dim_p, dim_t, 0);
//
//    StdparArray::dft_rc(data_c, f_data, dim_p, dim_t, 0);
//    StdparArray::dft_cc(data_c, data_c, dim_p, dim_t, 1);
//
////    StdparArray::dft_rc_2d_test(data_c, f_data, dim_t, dim_p);   //Be careful about the relative order of two dimensions!!
//    t_temp += omp_get_wtime();
...
//////      StdparArray::dft_rc(test_out, test_in, n0, n1, 0);
//////      StdparArray::dft_cc(test_out, test_out, n0, n1, 1);
////      StdparArray::dft_rc_2d_test(test_out, test_in, n1, n0);      
...
GenStdpar::ImpactTransform::~ImpactTransform() {}

Waveform::realseq_t GenStdpar::ImpactTransform::waveform(int iwire) const
{
